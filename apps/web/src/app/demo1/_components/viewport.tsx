    ...
    <div className="flex flex-col overflow-hidden rounded-md border bg-background [&>main]:flex-1 [&>main]:rounded-none [&>main]:border-none">
      <div className="grid h-7 grid-cols-[1fr_auto_1fr] items-center bg-muted px-2 font-bold text-foreground/70 text-sm">
        <div className="flex items-center gap-2">
          <div className="size-[11.5px] rounded-full bg-red-400/60" />
          <div className="size-[11.5px] rounded-full bg-yellow-400/60" />
          <div className="size-[11.5px] rounded-full bg-green-400/60" />
        </div>
        <div>raichu</div>
        <div />
      </div>
...
export function Viewport({
  ...
  return (
    <div
      className={cn("grid h-svh overflow-hidden overscroll-none bg-black/50 p-1.5", className)}
      {...props}
    >
